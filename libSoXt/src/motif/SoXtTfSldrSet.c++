...
|
|   Classes:
|      Subclass of SoXtSliderSet that acts on transform nodes
...
//
// Description:
//	Constructor for the SoXtTransformSliderSet.  Creates the 5 slider modules
...
// Use: public
void
SoXtTransformSliderSet::constructorCommon(SbBool buildNow)
//
//////////////////////////////////////////////////////////////////////
{
    ...
    _subComponentArray[2] = NULL;
    _subComponentArray[3] = NULL;
    _subComponentArray[4] = NULL;
...
Widget
SoXtTransformSliderSet::buildWidget(Widget parent)
{
    Arg  wargs[10];
    ...
    _subComponentArray[0] = new SoXtTransSliderModule(widget);
    _subComponentArray[1] = new SoXtScaleSliderModule(widget);
    _subComponentArray[2] = new SoXtRotateSliderModule(widget);
    _subComponentArray[3] = new SoXtScaleOrientationSliderModule(widget);
    _subComponentArray[4] = new SoXtCenterSliderModule(widget);
...
//
const char *
SoXtTransformSliderSet::getDefaultWidgetName() const
{ return "SoXtTransformSliderSet"; }

const char *
SoXtTransformSliderSet::getDefaultTitle() const
{ return "Transform Editor"; }

const char *
SoXtTransformSliderSet::getDefaultIconTitle() const
{ return "Xf Editor"; }
