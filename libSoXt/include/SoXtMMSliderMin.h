...
#ifndef SO_XT_MM_SLIDER_MIN_
#define SO_XT_MM_SLIDER_MIN_

#include <Inventor/Xt/SoXtSliderSetBase.h>

#define DEFAULT_SLIDER_TOOL_MIN_LABEL "min"

class SoXtSliderTool;

class SoXtMMSliderMin : public SoXtSliderSetBase
{
  public:
      SoXtMMSliderMin(
	Widget parent = NULL,
	...
	SbBool buildInsideParent = TRUE);
      ~SoXtMMSliderMin();
  // internal:
      static void minCallback(Widget w, void *client_data, void *call_data );
