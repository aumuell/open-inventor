...
SO_NODE_SOURCE(SoV1SphereKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1SphereKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1SphereKit);
...
SoV1SphereKit::SoV1SphereKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1SphereKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1SphereKit, SoV1ShapeKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("shape", SoSphere, SoSphere );
	...
	setAnyPart( "shape", mySphere, TRUE );
    }
}
