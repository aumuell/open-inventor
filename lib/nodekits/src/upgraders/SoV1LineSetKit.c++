...
SO_NODE_SOURCE(SoV1LineSetKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1LineSetKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1LineSetKit);
...
SoV1LineSetKit::SoV1LineSetKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1LineSetKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1LineSetKit, SoV1VertexShapeKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("shape", SoLineSet, SoLineSet );
