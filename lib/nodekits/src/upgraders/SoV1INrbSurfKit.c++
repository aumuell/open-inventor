...
SO_NODE_SOURCE(SoV1IndexedNurbsSurfaceKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1IndexedNurbsSurfaceKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1IndexedNurbsSurfaceKit);
...
SoV1IndexedNurbsSurfaceKit::SoV1IndexedNurbsSurfaceKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1IndexedNurbsSurfaceKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1IndexedNurbsSurfaceKit, SoV1ShapeKit );
    ...
    // the profileList can contain both SoNurbsProfile and
    // SoLinearProfile nodes. Hence the call to '...ADD_LIST_ITEM_TYPE'
    SO_V1_SUBKIT_ADD_CATALOG_LIST_ENTRY("profileList", SoGroup,
		    "topSeparator", "shape", SoProfile, TRUE );

    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("shape", SoIndexedNurbsSurface, 
...
SoNode *
SoV1IndexedNurbsSurfaceKit::createNewNode()
{
