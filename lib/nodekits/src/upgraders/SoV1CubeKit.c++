...
SO_NODE_SOURCE(SoV1CubeKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1CubeKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1CubeKit);
...
SoV1CubeKit::SoV1CubeKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1CubeKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1CubeKit, SoV1ShapeKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("shape", SoCube, SoCube );
