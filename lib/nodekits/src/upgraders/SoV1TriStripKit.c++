...
SO_NODE_SOURCE(SoV1TriangleStripSetKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1TriangleStripSetKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1TriangleStripSetKit);
...
SoV1TriangleStripSetKit::SoV1TriangleStripSetKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1TriangleStripSetKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1TriangleStripSetKit, SoV1VertexShapeKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("shape", SoTriangleStripSet, 
					 SoTriangleStripSet );
...
SoNode *
SoV1TriangleStripSetKit::createNewNode()
{
