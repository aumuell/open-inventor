...
SO_NODE_SOURCE(SoV1PointLightKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1PointLightKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1PointLightKit);
...
SoV1PointLightKit::SoV1PointLightKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1PointLightKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1PointLightKit, SoV1LightKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("light", SoPointLight,
					 SoPointLight );
	...
	setAnyPart("light", myPointLight, TRUE );
    }
}
...
SoNode *
SoV1PointLightKit::createNewNode()
{
