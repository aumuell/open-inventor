...
SO_NODE_SOURCE(SoV1SpotLightKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1SpotLightKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1SpotLightKit);
...
SoV1SpotLightKit::SoV1SpotLightKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1SpotLightKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1SpotLightKit, SoV1LightKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("light", SoSpotLight, SoSpotLight );
	...
	setAnyPart("light", mySpotLight, TRUE );
    }
}
...
SoNode *
SoV1SpotLightKit::createNewNode()
{
