...
SO_NODE_SOURCE(SoV1Text3Kit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1Text3Kit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1Text3Kit);
...
SoV1Text3Kit::SoV1Text3Kit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1Text3Kit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1Text3Kit, SoV1ShapeKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("shape", SoText3, SoText3 );
