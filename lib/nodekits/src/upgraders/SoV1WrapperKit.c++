...
SO_NODE_SOURCE(SoV1WrapperKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1WrapperKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1WrapperKit);
...
SoNode *
SoV1WrapperKit::createNewNode()
{
    return new SoWrapperKit;
}
