...
SO_NODE_SOURCE(SoV1PointSetKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1PointSetKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1PointSetKit);
...
SoV1PointSetKit::SoV1PointSetKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1PointSetKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1PointSetKit, SoV1VertexShapeKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("shape", SoPointSet, SoPointSet );
