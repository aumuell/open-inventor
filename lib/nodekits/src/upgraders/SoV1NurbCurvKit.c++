...
SO_NODE_SOURCE(SoV1NurbsCurveKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1NurbsCurveKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1NurbsCurveKit);
...
SoNode *
SoV1NurbsCurveKit::createNewNode()
{
