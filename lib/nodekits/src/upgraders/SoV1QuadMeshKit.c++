...
SO_NODE_SOURCE(SoV1QuadMeshKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1QuadMeshKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1QuadMeshKit);
...
SoV1QuadMeshKit::SoV1QuadMeshKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1QuadMeshKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1QuadMeshKit, SoV1VertexShapeKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("shape", SoQuadMesh, SoQuadMesh );
