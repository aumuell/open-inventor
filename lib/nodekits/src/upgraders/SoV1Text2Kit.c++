...
SO_NODE_SOURCE(SoV1Text2Kit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1Text2Kit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1Text2Kit);
...
SoV1Text2Kit::SoV1Text2Kit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1Text2Kit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1Text2Kit, SoV1ShapeKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("shape", SoText2, SoText2 );
