...
SO_NODE_SOURCE(SoV1PerspectiveCameraKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1PerspectiveCameraKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1PerspectiveCameraKit);
...
SoV1PerspectiveCameraKit::SoV1PerspectiveCameraKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1PerspectiveCameraKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1PerspectiveCameraKit, SoV1CameraKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("camera", SoPerspectiveCamera,
					  SoPerspectiveCamera );
	...
	SoPerspectiveCamera *myPerspectiveCamera = new SoPerspectiveCamera;
	setAnyPart("camera", myPerspectiveCamera, TRUE );
    }
}
...
SoNode *
SoV1PerspectiveCameraKit::createNewNode()
{
