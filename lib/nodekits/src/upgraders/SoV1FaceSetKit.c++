...
SO_NODE_SOURCE(SoV1FaceSetKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1FaceSetKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1FaceSetKit);
...
SoV1FaceSetKit::SoV1FaceSetKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1FaceSetKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1FaceSetKit, SoV1VertexShapeKit );
