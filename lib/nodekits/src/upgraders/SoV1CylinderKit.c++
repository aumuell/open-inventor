...
SO_NODE_SOURCE(SoV1CylinderKit);

// Define the required catalog inquiry methods
SO_V1_SUBKIT_CATALOG_VARS(SoV1CylinderKit);
SO_V1_SUBKIT_CATALOG_METHODS(SoV1CylinderKit);
...
SoV1CylinderKit::SoV1CylinderKit()
//
////////////////////////////////////////////////////////////////////////
{
    SO_NODE_CONSTRUCTOR(SoV1CylinderKit);
    ...
    SO_V1_SUBKIT_INHERIT_CATALOG(SoV1CylinderKit, SoV1ShapeKit );
    SO_V1_SUBKIT_CHANGE_ENTRY_TYPE("shape", SoCylinder, SoCylinder );
	...
	setAnyPart( "shape", myCylinder, TRUE );
    }
}
