...
SoBoundingBoxCache::SoBoundingBoxCache(SoState *state) : SoCache(state)
//
////////////////////////////////////////////////////////////////////////
{
    hasLOrP = FALSE;
...
SoBoundingBoxCache::set(const SbXfBox3f &boundingBox, 
			SbBool cSet, const SbVec3f &centerPoint)
//
////////////////////////////////////////////////////////////////////////
{
    box = boundingBox;
    projectedBox = box.project();
    centerSet = cSet;
    center = centerPoint;
}
...
////////////////////////////////////////////////////////////////////////
{
    ...
    const SoCacheElement *ce = (const SoCacheElement *)
	state->getConstElement(SoCacheElement::getClassStackIndex());
