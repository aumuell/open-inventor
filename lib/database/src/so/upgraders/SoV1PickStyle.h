 ...
 *
 ...
 |
 |   Description:
 |	Upgrade from 1.0 PickStyle format to the 2.0 format
 |
...
//  Class: SoV1PickStyle
//
//  V1PickStyle for upgrading 1.0 PickStyles to the 2.0 file format.
//
//////////////////////////////////////////////////////////////////////////////

class SoV1PickStyle : public SoUpgrader {

    SO_NODE_HEADER(SoV1PickStyle);
