 ...
 *
 ...
 |
 |   Description:
 |	Upgrade from 2.0 LOD unknown node format to the 2.1 known format
 |
 |   Author(s)		: David Mott
 |
 ______________  S I L I C O N   G R A P H I C S   I N C .  ____________
...
//  Class: SoV2LOD
//
//  This is EXACTLY the same format as the 2.1 LOD, but it looks for
//  the alternateRep field (which does not exist in 2.1 for LOD).
//
//////////////////////////////////////////////////////////////////////////////

class SoV2LOD : public SoUpgrader {

    SO_NODE_HEADER(SoV2LOD);
