 ...
 * To maintain a fully accurate histogram, we'd need to allocate a "int32_t"
 * (preferably uint32_t) for each cell.  In practice this is overkill;
...
/* and recompute its volume and population */
{
 ...
 have_c2max:
   ...
   * against making int32_t narrow boxes, and it has the side benefit that
