...
#define JMSG_STR_PARM_MAX  80
   ...
   * end of processing.
   */
  int32_t num_warnings;		/* number of corrupt-data warnings */
...
struct jpeg_progress_mgr {
  ...
  int32_t pass_counter;		/* work units completed in this pass */
  int32_t pass_limit;		/* total number of work units in this pass */
...
struct jpeg_source_mgr {
  ...
  JMETHOD(void, skip_input_data, (j_decompress_ptr cinfo, int32_t num_bytes));
...
struct jvirt_sarray_control { int32_t dummy; };
struct jvirt_barray_control { int32_t dummy; };
struct jpeg_comp_master { int32_t dummy; };
struct jpeg_c_main_controller { int32_t dummy; };
struct jpeg_c_prep_controller { int32_t dummy; };
struct jpeg_c_coef_controller { int32_t dummy; };
struct jpeg_marker_writer { int32_t dummy; };
struct jpeg_color_converter { int32_t dummy; };
struct jpeg_downsampler { int32_t dummy; };
struct jpeg_forward_dct { int32_t dummy; };
struct jpeg_entropy_encoder { int32_t dummy; };
struct jpeg_decomp_master { int32_t dummy; };
struct jpeg_d_main_controller { int32_t dummy; };
struct jpeg_d_coef_controller { int32_t dummy; };
struct jpeg_d_post_controller { int32_t dummy; };
struct jpeg_marker_reader { int32_t dummy; };
struct jpeg_entropy_decoder { int32_t dummy; };
struct jpeg_inverse_dct { int32_t dummy; };
struct jpeg_upsampler { int32_t dummy; };
struct jpeg_color_deconverter { int32_t dummy; };
struct jpeg_color_quantizer { int32_t dummy; };
