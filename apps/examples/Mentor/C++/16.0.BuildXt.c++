 ...
 *  chapter 16, example 0.
 *
 *  This example shows how to use Inventor in the X
 *  programming environment. It performs initialization,
 *  render area creation, and starts the event loop.
 *-----------------------------------------------------------*/
