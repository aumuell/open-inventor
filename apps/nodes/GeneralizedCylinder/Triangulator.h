...
class Triangulator
{
  public:
    ...
    static SbBool triangEdgeTest( const SoMFVec3f &coords, int32_t e0p0, int32_t e0p1,
				int32_t e1p0, int32_t e1p1 );
    static SbBool triangInsideTest( const SoMFVec3f &coords, 
				    int32_t testPt, int32_t pt0, int32_t pt1, int32_t pt2 );
    static SbBool triangulate( const SoMFVec3f &coords, const SoMFInt32 &input,
				SoMFInt32 &output );
};
